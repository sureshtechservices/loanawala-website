    ...
    <div className="home-page">
      <section className="hero-section bg-primary text-center section-padding">
        <div className="container">
          <h1>Welcome to Loanawala Consultancy</h1>
      ...
      <section className="about-preview section-padding text-center">
        <div className="container">
          <h2>About Us</h2>
          <p>Loanawala Consultancy is dedicated to empowering students with the resources and guidance needed to pursue their academic aspirations globally. We specialize in education loan assistance and personalized consultancy services.</p>
